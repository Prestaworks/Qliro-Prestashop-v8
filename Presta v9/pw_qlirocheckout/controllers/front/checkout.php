...
class Pw_qlirocheckoutCheckoutModuleFrontController extends ModuleFrontController
{
    ...
    {
        parent::setMedia();
        if ('hummingbird' == $this->context->shop->theme_name) {
            $this->context->controller->addCSS(_MODULE_DIR_.'pw_qlirocheckout/views/css/qlirocheckout_hummingbird_style.css', 'all');
        } else {
